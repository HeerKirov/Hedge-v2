import { Ref } from "vue"
import { ScrollView } from "@/components/logicals/VirtualScrollView"
import { PaginationDataView, QueryEndpointInstance, QueryEndpointResult, SingletonDataView, SliceDataView } from "@/functions/endpoints/query-endpoint"
import { Illust, IllustType, Tagme } from "@/functions/adapter-http/impl/illust"
import { useCreatingCollectionService } from "@/layouts/globals/GlobalDialog/CreatingCollection"
import { useCreatingAlbumService, useAddToFolderService, useCloneImageService } from "@/layouts/globals/GlobalDialog"
