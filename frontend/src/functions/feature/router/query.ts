 ...
 */
export function useRouterQuery<N extends RouteName, Q extends keyof RouteParameter[N]["query"], P extends RouteParameter[N]["query"][Q]>(routerName: N, queryName: Q,
                                                    encode: (d: P) => string,
                                                    decode: (param: string) => P | null): Ref<P | null> {
