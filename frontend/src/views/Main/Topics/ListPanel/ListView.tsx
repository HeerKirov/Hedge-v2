...
const Item = defineComponent({
    ...
    setup(props, { emit }) {
        ...
        //TODO 确定title颜色
        return () => <tr onClick={click} onContextmenu={rightClick} onMouseover={mouseover} onMouseleave={mouseleave} style="height: 50px">
            <td class="is-width-50 is-cursor-pointer" onClick={() => console.log("1")}>
