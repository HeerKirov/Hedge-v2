...
import {
    CollectionRelatedItems,
    CollectionRelatedUpdateForm,
...
import {
    PaginationDataView,
    QueryEndpointResult,
    SingletonDataView, usePaginationDataView,
    useQueryEndpoint
} from "@/functions/utils/endpoints/query-endpoint"
...
import { LimitAndOffsetFilter } from "@/functions/adapter-http/impl/generic";
...
function useViewController() {
    ...
    }>("collection-preview-view-controller", {
