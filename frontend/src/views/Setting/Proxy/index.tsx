...
export default defineComponent({
    setup() {
        ...
        return () => loading.value ? <div/> : <div>
            ...
            <div class="group">
                <Input placeholder="http://" value={http.value} onUpdateValue={setHttp} refreshOnInput={true}/>
            ...
            <div class="group">
                <Input placeholder="socks5://" value={s5.value} onUpdateValue={setS5} refreshOnInput={true}/>
