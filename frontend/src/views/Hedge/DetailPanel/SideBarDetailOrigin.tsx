...
export default defineComponent({
    setup() {
        ...
        return () => <div class="v-side-bar-detail origin">
            <p class="is-size-7"><i class="fa fa-pager mr-2"/><span class="can-select">pixiv <b>98120978</b></span></p>
            <h1 class="is-size-6">这一行是标题</h1>
            <p class="is-size-7 mt-4"><i class="fa fa-file-image mr-2"/><b>JPEG</b>图片</p>
            <div class="mt-4">
