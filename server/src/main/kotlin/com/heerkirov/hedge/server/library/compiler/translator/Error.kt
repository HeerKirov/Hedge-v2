 ...
 */
class ElementCannotBeExported(item: String) : TranslatorError<String>(4006, "Annotation '$item' cannot be exported, so it cannot be used in illust/album query.", info = item)
